          ...
          <div>
            ...
            <div className="relative mt-2">
              <Input
                ...
                className="h-12 w-full rounded-xl border-gray-200 pr-12 bg-white transition-all hover:bg-gray-50 focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10 shadow-sm"
        ...
        <div className="rounded-xl border border-blue-100 bg-blue-50 p-5 shadow-sm">
           <div className="flex gap-4">
             ...
             <div className="text-sm text-blue-900">
               <p className="font-semibold text-blue-950">Información importante:</p>
