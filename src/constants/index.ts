...
export const COLORES_ESTADO_OBRA: Record<
  (typeof ESTADOS_OBRA)[number],
  string
> = {
...
export const COLORES_ESTADO_VISITA: Record<
  (typeof ESTADOS_VISITA)[number],
  string
> = {
  PENDIENTE: '#94a3b8',
  'SIN AGENDAR': '#64748b',
...
export const COLORES_ESTADO_ENTREGA: Record<
  (typeof ESTADOS_ENTREGA)[number],
  string
> = {
  PENDIENTE: '#3b82f6',
  'EN CURSO': '#f59e0b',
